import { ModelProviderName, Character } from "@elizaos/core";
import { orderbookPlugin } from '@elizaos/plugin-ai-orderbook'
//import { defaultCharacter } from "./defaultCharacter";

export const cryptoCharacter: Character = {
    name: "orderbook_baddie",
    ...
    //bug where knowledge array isn't properly parsed, fails to startup agent
    // knowledge: [
